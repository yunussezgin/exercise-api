...
public class ExceptionHandlingController {
    ...
    public ResponseEntity<ErrorResponse> handleBadRequestException(BadRequestException e) {
        log.error("Exercise service exception occurred -> BadRequestException: {}", e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleNotFoundValidationException(NotFoundException e) {
        log.error("Exercise service exception occurred -> NotFoundException: {}", e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> otherExceptions(Exception e) {
        log.error("Exercise service exception occurred -> RuntimeException: {}", ExceptionUtils.getMessage(e));
